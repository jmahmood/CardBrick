...
pub struct Config {
    ...
    pub fallback_font_path: PathBuf,
...
impl Config {
    pub fn new() -> Self {
        ...
        Self {
            ...
            emoji_font_path: base_assets.join("font/NotoSansSymbols-Regular.ttf"),
            fallback_font_path: base_assets.join("font/NotoSansSymbols2-Regular.ttf"),
            font_size_large: 32,
            font_size_medium: 24,
            font_size_small: 18,
